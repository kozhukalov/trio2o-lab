...
export ENTRYPOINT_HOST=${ENTRYPOINT_HOST:-keystone}
...
keystone-manage bootstrap \
  ...
  --bootstrap-admin-url http://${ENTRYPOINT_HOST}:5000/v3/ \
  --bootstrap-internal-url http://${ENTRYPOINT_HOST}:5000/v3/ \
  --bootstrap-public-url http://${ENTRYPOINT_HOST}:5000/v3/ \
