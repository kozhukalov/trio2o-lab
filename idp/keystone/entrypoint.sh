...
export IDP_ENTITY_ID=${IDP_ENTITY_ID:-https://${ENDPOINT_HOST}/v3/OS-FEDERATION/saml2/idp}
export IDP_SSO_ENDPOINT=${IDP_SSO_ENDPOINT:-https://${ENDPOINT_HOST}/v3/OS-FEDERATION/saml2/sso}
