...
export IDP_ENTITY_ID=${IDP_ENTITY_ID:-http://${ENDPOINT_HOST}/v3/OS-FEDERATION/saml2/idp}
export IDP_SSO_ENDPOINT=${IDP_SSO_ENDPOINT:-http://${ENDPOINT_HOST}/v3/OS-FEDERATION/saml2/sso}
